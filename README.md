...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/catkin_pkg-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/catkin_pkg-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install catkin_pkg
```
...
It is possible to list all of the versions of `catkin_pkg` available on your platform:
...
```
pixi search catkin_pkg --channel conda-forge
```
