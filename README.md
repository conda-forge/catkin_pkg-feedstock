...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/catkin_pkg-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7238&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/catkin_pkg-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `catkin_pkg` can be installed with:

```
conda install catkin_pkg
```

It is possible to list all of the versions of `catkin_pkg` available on your platform with:
